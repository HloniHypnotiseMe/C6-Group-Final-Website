...
exports.allAgents = exports.codeAssistantAgent = exports.dataAnalystAgent = exports.customerSupportAgent = exports.marketingStrategistAgent = exports.salesAssistantAgent = exports.emailAssistantAgent = exports.chatbotAgent = exports.contentGeneratorAgent = exports.seoAnalyzerAgent = exports.businessAuditAgent = void 0;
exports.getAgent = getAgent;
exports.getAllAgentTypes = getAllAgentTypes;
...
// ============================================
exports.salesAssistantAgent = {
    id: 'agent-sales-assistant',
    agentType: types_1.AgentType.SALES_ASSISTANT,
...
// ============================================
exports.marketingStrategistAgent = {
    id: 'agent-marketing-strategist',
    agentType: types_1.AgentType.MARKETING_STRATEGIST,
...
// ============================================
exports.customerSupportAgent = {
    id: 'agent-customer-support',
    agentType: types_1.AgentType.CUSTOMER_SUPPORT,
...
exports.dataAnalystAgent = {
    ...
    agentType: types_1.AgentType.DATA_ANALYST,
...
// ============================================
exports.codeAssistantAgent = {
    id: 'agent-code-assistant',
    agentType: types_1.AgentType.CODE_ASSISTANT,
...
// ============================================
exports.allAgents = {
    [types_1.AgentType.BUSINESS_AUDIT]: exports.businessAuditAgent,
    [types_1.AgentType.SEO_ANALYZER]: exports.seoAnalyzerAgent,
    [types_1.AgentType.CONTENT_GENERATOR]: exports.contentGeneratorAgent,
    [types_1.AgentType.CHATBOT]: exports.chatbotAgent,
    [types_1.AgentType.EMAIL_ASSISTANT]: exports.emailAssistantAgent,
    [types_1.AgentType.SALES_ASSISTANT]: exports.salesAssistantAgent,
    [types_1.AgentType.MARKETING_STRATEGIST]: exports.marketingStrategistAgent,
    [types_1.AgentType.CUSTOMER_SUPPORT]: exports.customerSupportAgent,
    [types_1.AgentType.DATA_ANALYST]: exports.dataAnalystAgent,
    [types_1.AgentType.CODE_ASSISTANT]: exports.codeAssistantAgent
};
// Helper function to get agent by type
function getAgent(agentType) {
    return exports.allAgents[agentType];
}
// Helper function to get all agent types
function getAllAgentTypes() {
    return Object.values(types_1.AgentType);
}
// Helper function to get agent info for display
function getAgentInfo(agentType) {
    const agent = exports.allAgents[agentType];
    return {
        id: agent.id,
        name: agent.name,
