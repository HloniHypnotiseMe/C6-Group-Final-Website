...
export const packageConfigs: Record<PackageType, PackageConfig> = {
  [PackageType.LEAD]: {
    id: PackageType.LEAD,
    name: 'Lead Package',
    monthlyPrice: getCommercialPackage("LEAD").monthlyPriceZar ?? 0,
    annualPrice: getCommercialPackage("LEAD").annualPriceZar ?? 0,
    aiLimits: {
  ...
  [PackageType.DIAMOND]: {
    ...
    name: 'Diamond',
    monthlyPrice: getCommercialPackage("DIAMOND").monthlyPriceZar ?? 0,
    annualPrice: getCommercialPackage("DIAMOND").annualPriceZar ?? 0,
    aiLimits: {
      [AgentType.BUSINESS_AUDIT]: 5, [AgentType.SEO_ANALYZER]: 20, [AgentType.CONTENT_GENERATOR]: 50,
      [AgentType.CHATBOT]: 500, [AgentType.EMAIL_ASSISTANT]: 100, [AgentType.SALES_ASSISTANT]: 50,
      [AgentType.MARKETING_STRATEGIST]: 10, [AgentType.CUSTOMER_SUPPORT]: 0, [AgentType.DATA_ANALYST]: 0,
      [AgentType.CODE_ASSISTANT]: 0,
    },
    features: [
  ...
  [PackageType.GOLD]: {
    id: PackageType.GOLD,
    name: 'Gold',
    monthlyPrice: getCommercialPackage("GOLD").monthlyPriceZar ?? 0,
    annualPrice: getCommercialPackage("GOLD").annualPriceZar ?? 0,
    aiLimits: {
      [AgentType.BUSINESS_AUDIT]: 10, [AgentType.SEO_ANALYZER]: 100, [AgentType.CONTENT_GENERATOR]: 200,
      [AgentType.CHATBOT]: 2000, [AgentType.EMAIL_ASSISTANT]: 500, [AgentType.SALES_ASSISTANT]: 200,
      [AgentType.MARKETING_STRATEGIST]: 50, [AgentType.CUSTOMER_SUPPORT]: 100, [AgentType.DATA_ANALYST]: 50,
  ...
  [PackageType.PLATINUM]: {
    ...
    name: 'Platinum',
    monthlyPrice: getCommercialPackage("PLATINUM").monthlyPriceZar ?? 0,
    annualPrice: getCommercialPackage("PLATINUM").annualPriceZar ?? 0,
    aiLimits: {
      [AgentType.BUSINESS_AUDIT]: 50, [AgentType.SEO_ANALYZER]: 200, [AgentType.CONTENT_GENERATOR]: 500,
      [AgentType.CHATBOT]: 10000, [AgentType.EMAIL_ASSISTANT]: 2000, [AgentType.SALES_ASSISTANT]: 1000,
      [AgentType.MARKETING_STRATEGIST]: 100, [AgentType.CUSTOMER_SUPPORT]: 500, [AgentType.DATA_ANALYST]: 200,
  ...
  [PackageType.ENTERPRISE]: {
    ...
    annualPrice: 0,
    aiLimits: {
      [AgentType.BUSINESS_AUDIT]: -1, [AgentType.SEO_ANALYZER]: -1, [AgentType.CONTENT_GENERATOR]: -1,
      [AgentType.CHATBOT]: -1, [AgentType.EMAIL_ASSISTANT]: -1, [AgentType.SALES_ASSISTANT]: -1,
      [AgentType.MARKETING_STRATEGIST]: -1, [AgentType.CUSTOMER_SUPPORT]: -1, [AgentType.DATA_ANALYST]: -1,
...
export function hasExceededAILimit(packageType: PackageType, agentType: AgentType, currentUsage: number): boolean {
...
export function getRemainingAICalls(packageType: PackageType, agentType: AgentType, currentUsage: number): number {
  const config = packageConfigs[packageType];
  const limit = config.aiLimits[agentType];
  if (limit === -1) return -1;
  if (limit === 0) return 0;
...
export const AGENT_DEFAULT_MODELS: Record<AgentType, string> = {
  [AgentType.BUSINESS_AUDIT]: 'openrouter/free', [AgentType.SEO_ANALYZER]: 'gpt-4o-mini',
  [AgentType.CONTENT_GENERATOR]: 'claude-3-5-sonnet', [AgentType.CHATBOT]: 'gpt-4o-mini',
  [AgentType.EMAIL_ASSISTANT]: 'claude-3-haiku', [AgentType.SALES_ASSISTANT]: 'gpt-4o-mini',
  [AgentType.MARKETING_STRATEGIST]: 'gpt-4o', [AgentType.CUSTOMER_SUPPORT]: 'claude-3-haiku',
  [AgentType.DATA_ANALYST]: 'gpt-4o', [AgentType.CODE_ASSISTANT]: 'claude-3-5-sonnet',
};
